...
public class TestClusterActor extends TestCase {
  ...
  private final static String TEST_FOLDER_PROPNAME = "test.folder";
  ...
  public void setUp() throws Exception {
    ...
    File defaultRootFolderPath = new File(userHome, "dls_trials");
    testFolder = System.getProperty(TEST_FOLDER_PROPNAME, defaultRootFolderPath.getAbsolutePath());
  }
